...
read -p "Enter total output video stretch duration in real seconds (e.g. 30.0) [30.0]: " VIDEO_STRETCH_SEC
VIDEO_STRETCH_SEC=${VIDEO_STRETCH_SEC:-30.0}

# Safe derived variable assignment to prevent unbound errors
