...
# ==============================================================================
# PYTHON VOLUMETRIC 3D ENGINE WRITER (WINMAC / CROSS-PLATFORM)
# ==============================================================================
...
try:
    print("[Python] Initializing True 3D Volumetric Tensor Reality Engine [WinMac / Cross-Platform Mode]...")
    ...
    def get_available_encoder():
        try:
            ...
            elif 'mpeg4' in res.stdout: return 'mpeg4'
        except Exception:
            pass
        return 'mpeg4'

    chosen_encoder = get_available_encoder()
    print(f"[Python] Selected WinMac FFmpeg video encoder: {chosen_encoder}")
...
echo -e "\n${CYAN}==============================================================================${NC}"
echo -e "${GREEN}    WINMAC VOLUMETRIC PIPELINE RENDER FINISHED SUCCESSFULLY              ${NC}"
echo -e "${CYAN}==============================================================================${NC}"
